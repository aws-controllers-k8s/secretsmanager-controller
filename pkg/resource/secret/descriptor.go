...
const (
	finalizerString = "finalizers.secretsmanager.services.k8s.aws/Secret"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("secrets")

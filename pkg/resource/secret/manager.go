...
// +kubebuilder:rbac:groups=secretsmanager.services.k8s.aws,resources=secrets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=secretsmanager.services.k8s.aws,resources=secrets/status,verbs=get;update;patch
...
type resourceManager struct {
	...
	sdkapi svcsdkapi.SecretsManagerAPI
}
